 ...
 *   · un ícono de lupa siempre visible, que es la
...
export function TraceableValue({
  ...
  return (
    ...
    >
      <span className="min-w-0 underline decoration-action/50 decoration-dotted underline-offset-4">
        {children}
      </span>
      <Search
        aria-hidden
        className="size-3 shrink-0 text-action opacity-70 transition-opacity duration-150"
      />
    </button>
  );
}
